...
SET company = 'Company BB'
	...
	, business_phone = '(901)555-0100'
	, fax_number = '(901)555-0101'
	, address = '789 28th Street'
	, city = 'Memphis'
	, state_province = 'TN'
	, zip_postal_code = '37544'
	, country_region = 'USA'
WHERE id = 28;
...
SET supplier_ids = 6,
    ...
    description = 'Heart Healthy Savory Soup',
    standard_cost = 1,
    list_price = 1.89,
    reorder_level = 100,
    target_level = 200,
...
SET supplier_ids = 6,
    ...
    description = 'Delicious Savory Soup',
    standard_cost = 1,
    list_price = 1.95,
    reorder_level = 100,
    target_level = 200,
